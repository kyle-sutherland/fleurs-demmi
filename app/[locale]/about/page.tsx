      ...
      <main className="flex flex-col">
        ...
        <div className="grid grid-cols-2 gap-4 mt-8 mx-12 md:mx-32">
          <div className="relative aspect-[3/4]">
            <Image src="/60c13257-cae1-486f-b37a-683c0594416b.jpeg" alt="Emily Gray with flower cart" fill className="object-cover" priority />
          </div>
          <div className="relative aspect-[3/4]">
            <Image src="/ee457bb0-6711-4bd4-a478-09e127b505a6.jpeg" alt="Emily Gray watering plants" fill className="object-cover" />
          </div>
        </div>
