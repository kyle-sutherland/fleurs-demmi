  ...
  return (
    <div className="grow row-start-2">
      ...
      >
        ...
        <div className="flex-1 flex items-center border-2 border-[#ff5129] rounded-full bg-foreground/5 pr-1 md:rounded-none md:border-0 md:bg-transparent md:p-0 md:flex-none md:contents">
          <input
            type="email"
            placeholder={t.email}
            {...register("email", {
            ...
            className="flex-1 bg-transparent font-sans text-sm px-5 py-3 focus:outline-none w-full placeholder:text-foreground/40 md:border-2 md:border-[#ff5129] md:rounded-full md:bg-foreground/5 md:focus:border-orange-400"
          />
          <button
            type="submit"
        ...
        <button
          type="submit"
          disabled={isSubmitting || !turnstileToken}
          className="hidden md:block font-sans text-sm uppercase tracking-widest border-2 border-foreground text-foreground px-4 py-2 hover:bg-[#ff5129] hover:border-[#E6E6FA] hover:text-[#E6E6FA] transition-colors whitespace-nowrap disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {isSubmitting ? "…" : t.submit}
        </button>
