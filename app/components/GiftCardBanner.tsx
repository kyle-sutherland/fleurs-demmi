  ...
  return (
    ...
    >
      <div className="p-5 flex flex-col gap-3">
        ...
        <span className="mt-2 self-start font-sans font-semibold text-sm uppercase tracking-widest border-2 border-foreground text-foreground px-10 py-3 group-hover:bg-[#ff5129] group-hover:border-[#E6E6FA] group-hover:text-[#E6E6FA] transition-colors">
          Buy a Gift Card
        </span>
      </div>
    </Link>
