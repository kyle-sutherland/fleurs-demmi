...
export function WeddingsForm({ t }: Props) {
  ...
  return (
    <form onSubmit={handleSubmit} className="mt-8 flex flex-col gap-5">
      ...
      <Field label={t.eventDate} name="event_date" type="date" hint={t.eventDateHint} required />
      ...
      <div className="flex flex-col gap-1">
        <label className="font-sans text-xs uppercase tracking-widest font-semibold">{t.selectedItems}</label>
