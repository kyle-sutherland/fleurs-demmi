export const en = {
  ...
  weddings: {
    ...
    form: {
      ...
      items: ["Bridal bouquet", "Boutonniere", "Bridesmaids bouquets", "Corsages", "Centerpieces", "Floral installations & arches", "DIY floral bucket"],
  ...
  mothersDay: {
    ...
    form: {
      ...
      card: "Add a Card \u2014 $4 (optional)",
      cardName: "Name of Mother",
      cardMessage: "Message",
      paymentSoon: "Payment integration coming soon",
      submit: "Check Out",
    },
